...
Start-Process "C:\inetpub\wwwroot\CM\python\.venv\Scripts\python.exe" -ArgumentList "C:\inetpub\wwwroot\CM\python\ossi_service.py","--host","127.0.0.1","--port","18765","--data-dir","C:\inetpub\wwwroot\CM\data" -WorkingDirectory "C:\inetpub\wwwroot\CM\python" -WindowStyle Hidden
Start-Sleep 2
